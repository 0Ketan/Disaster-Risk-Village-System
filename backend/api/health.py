...
from ..clients.open_meteo_marine import probe_open_meteo_marine
...
def get_system_health():
    """
    Performs live connectivity checks against OpenTopoData, OpenWeatherMap, Meteostat, and Open-Meteo Marine.
    ...
    services = [topo_health, weather_health, meteo_health, marine_health]
